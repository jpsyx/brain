...
- **Durable receiver state.** Focused tests under `state/receiver/tests/`
  ...
  a fresh revision-zero recovery cursor that preserves first facts, and atomic
  recovery completion across the lifetime/current-attempt evidence split. The
  v9-to-v10 matrix derives finite active deadlines; partial-v10 repair restores
