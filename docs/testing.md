...
- **Automatic sync safety.** `sync/args.rs` proves watcher pushes use one-way,
  ...
  rewrites, project reverse-link regeneration, schema refusal, and counter
  floors. The CSV integration regression
