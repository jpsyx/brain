...
| **bucket** | One top-level directory the search view walks and groups results under: `capture/` plus the four PARA folders. | `entry::Bucket`; roots in `tui::search_view::all_bucket_roots` |
